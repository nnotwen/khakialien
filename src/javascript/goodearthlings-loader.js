...
$(function () {
  ...
  $.each(
    shuffleArray(goodearthlingsList) /*.splice(0,9)*/,
    function (_, entry) {
        ...
        `<div class="card swiper-slide">
            <div class="card-content">
              ...
              <div class="media-icons">
                <a ${
                  entry.facebookURL
                    ? `title="Facebook" href="${entry.facebookURL}" target="_blank"`
                    : 'title="Facebook: Not Found" class="swiper-media-disabled"'
                }>
                  <i class="fab fa-facebook"></i>
                </a>
                <a ${
                  entry.youtubeURL
                    ? `title="YouTube" href="${entry.youtubeURL}" target="_blank"`
                    : 'title="YouTube: Not Found" class="swiper-media-disabled"'
                }>
                  <i class="fab fa-youtube"></i>
                </a>
                <a ${
                  entry.twitterURL
                    ? `title="Twitter" href="${entry.twitterURL}" target="_blank"`
                    : 'title="Twitter: Not Found"class="swiper-media-disabled"'
                }>
