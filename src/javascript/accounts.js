const accounts = [
  {
    ...
    siteAvatar:
      "https://yt3.ggpht.com/ytc/AMLnZu9IjPTy-QrY5Vdu7Y1W2HEbjdTXL2QdkMCMxf-p=s88-c-k-c0x00ffffff-no-rj",
  ...
  },
  {
    ...
    siteBanner:
      "https://bandlabimages.azureedge.net/v1.0/users/670c0fd5-91d1-46f0-a1c2-18718a5eb035/320x320/blur",
    siteLogo: "https://www.techwibe.com/wp-content/uploads/2015/11/icon1.png",
    siteAvatar:
      "https://bandlabimages.azureedge.net/v1.0/users/670c0fd5-91d1-46f0-a1c2-18718a5eb035/160x160",
    accountNamePrimary: "Khaki Alien",
    accountNameSecondary: "@khaki_alien",
    description: "yo, i am Khaki Alien that can sing ig lol",
  },
  {
    ...
    accountNameSecondary:
      '<img style="height:15px;" src="https://osu.ppy.sh/assets/images/flags/1f1f5-1f1ed.svg"></img> Philippines',
    description: "yo, i am Khaki Alien that can sing ig lol",
  },
  {
    siteName: "steam",
    ...
    siteBanner:
      "https://cache.desktopnexus.com/thumbseg/2064/2064070-bigthumbnail.jpg",
    siteLogo: "https://img.icons8.com/fluency/344/steam.png",
    siteAvatar:
      "https://avatars.cloudflare.steamstatic.com/97b76e0e35ded7419524cda89c30bf2ff41a53f1_full.jpg",
  ...
  },
  {
    ...
    siteBanner:
      "https://cdn.windowsreport.com/wp-content/uploads/2019/09/Twitch-2.jpg",
    siteLogo:
      "https://www.freepnglogos.com/uploads/twitch-logo-transparent-png-20.png",
    siteAvatar:
      "https://static-cdn.jtvnw.net/jtv_user_pictures/7c0b6355-d7b0-4078-9636-c4eeb123ec32-profile_image-70x70.png",
    accountNamePrimary: "KhakiAlien",
    accountNameSecondary: "",
    ...
    $.each(accounts, function (_, entry) {
      container.append(
        `<div class="account-card">
          ...
          <a href="${
            entry.siteURL
          }" class="button-link" target="_blank">Visit</a>
          </div>
        </div>`
      );
    });
