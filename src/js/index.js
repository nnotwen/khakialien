...
$(function () {
  const accountInfo = [
    ...
    },
    {
      ...
      viewbox: "0 0 24 24",
      path: "M24 12v-.002c0-3.618-1.606-6.861-4.144-9.054l-.015-.013a20.22 20.22 0 0 0-4.967 3.713l-.004.004c.044.046.087.085.131.132 3.719 4.012 7.106 9.73 6.546 12.471a11.85 11.85 0 0 0 2.452-7.246v-.006zM12.591 3.955a12.722 12.722 0 0 1 5.872-2.022l.048-.003A11.834 11.834 0 0 0 12 .001c-2.171 0-4.207.579-5.962 1.591l.058-.031c.658.567 2.837.781 5.484 2.4a.954.954 0 0 0 1.015-.007l-.004.002zM9.166 6.778c.046-.049.093-.09.138-.138a28.609 28.609 0 0 0-3.806-3.1l-.099-.064a1.845 1.845 0 0 0-1.516-.305l.013-.002A11.953 11.953 0 0 0 0 12.009c0 2.909 1.037 5.576 2.762 7.651l-.016-.02c-1.031-2.547 2.477-8.672 6.419-12.862zm2.918 2.42c-3.962 3.503-9.477 8.73-8.632 11.218A11.936 11.936 0 0 0 11.994 24a11.94 11.94 0 0 0 8.826-3.883l.008-.009c.486-2.618-4.755-7.337-8.744-10.91z"
    }
  ];
  ...
  $.each(accountInfo.sort((a, b) => a.name - b.name), function (_, entry) {
    const $anchor = $("<a></a>")
